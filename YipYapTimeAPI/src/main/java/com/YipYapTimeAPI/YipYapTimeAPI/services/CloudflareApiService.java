...
public class CloudflareApiService {
    ...
    public CloudflareApiService(RestTemplate restTemplate) {
    ...
    public CloudflareApiResponse uploadImage(MultipartFile imageFile) throws IOException {
        ...
        ResponseEntity<CloudflareApiResponse> response = restTemplate.postForEntity(url, requestEntity, CloudflareApiResponse.class);
